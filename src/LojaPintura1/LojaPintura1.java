...
public class LojaPintura1 {
    static final int COBERTURA_DA_TINTA_EM_METROS_QUADRADOS = 3; // Cobertura da tinta é de 1 litro para cada 3 metros quadrados
    static final int LITRAGEM_DA_LATA_DE_TINTA = 18; // Cada lata tem 18 litros
    ...
    public static void main(String[] args) {
        ...
        int metragemQuadrada = scanner.nextInt();
        System.out.println("\n");

        int litrosgastos = calculaLitrosGastos(metragemQuadrada);
    ...
    public static int calculaLitrosGastos(int metragemQuadrada) {
    ...
    public static void mostraPrecoEQuantidadeTinta(double precoTotal, double latasgastas) {
        System.out.println("latas"+ latasgastas);
        //System.out.printf("|QUANTIDADE DE LATAS: %d  | \n|PREÇO TOTAL: R$ %d  |\n\n    VOLTE SEMPRE!", (int)latasgastas, precoTotal);
    }
